package com.reactivetechnologies.analytics.weka.impl;
...
public final class RegressionModel implements DataSerializable
{
	@Override
   ...
   */
	public final String writeClassifierAsXml() throws IOException
	{
	  try {
   ...
   */
	public final Classifier readClassifierAsXml(String xmlString) throws IOException
  {
    try {
      return (Classifier) XStream.deSerialize(xmlString);
  ...
  public void writeData(ObjectDataOutput out) throws IOException {
    try {
      ...
      out.writeUTF(writeClassifierAsXml());
    } catch (Exception e) {
      throw new IOException(e);
    }
  ...
  public void readData(ObjectDataInput in) throws IOException {
    ...
    try {
      ...
      setFolds(in.readInt());
      setName(in.readUTF());
      readClassifierAsXml(in.readUTF());
    } catch (Exception e) {
      throw new IOException(e);
    }
  }
